                ...
                <div className="flex flex-col md:flex-row justify-between items-start w-full">
                    ...
                    <div className="pointer-events-auto pt-16 md:pt-[10vh] w-full md:max-w-[42vw] text-center md:text-left z-30">
                        ...
                        >
                            ...
                            <span className="whitespace-nowrap flex md:inline items-baseline justify-center gap-[0.2em] lowercase md:uppercase font-normal md:font-black">KTORÉ<span className="hidden md:inline">&nbsp;</span>
